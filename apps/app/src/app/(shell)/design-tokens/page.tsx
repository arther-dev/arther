import { AppShell, Button, Divider, Skeleton, StatusPill } from '@arther/ui';
...
/**
 * Internal reference sheet proving the DS wiring (tokens.css → ui atoms →
 * Tailwind theme) end-to-end. Not part of the product IA.
 */
